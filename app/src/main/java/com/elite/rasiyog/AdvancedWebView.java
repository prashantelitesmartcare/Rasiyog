...
public class AdvancedWebView extends WebView {
	...
	protected static void setAllowAccessFromFileUrls(
		...
		if (Build.VERSION.SDK_INT >= 16) {
			webSettings.setAllowFileAccess(allowed);
	...
	protected void init(Context context) {
		...
		super.setWebViewClient(new WebViewClient() {
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				if (isHostnameAllowed(url)) {
					if (mCustomWebViewClient != null) {
						return mCustomWebViewClient.shouldOverrideUrlLoading(
								view, url);
					} else {
						return false;
					}
			 ...
			 * @SuppressLint("NewApi")
			 * 
			 * @SuppressWarnings("all") public WebResourceResponse
			 * shouldInterceptRequest(WebView view, WebResourceRequest request)
			 * { if (Build.VERSION.SDK_INT >= 21) { if (mCustomWebViewClient !=
			 * null) { return mCustomWebViewClient.shouldInterceptRequest(view,
			 * request); } else { return super.shouldInterceptRequest(view,
			 ...
			 * onReceivedClientCertRequest(WebView view, ClientCertRequest
			 * request) { if (Build.VERSION.SDK_INT >= 21) { if
			 ...
			 * 
			 * @SuppressWarnings("all") public void
			 * onUnhandledInputEvent(WebView view, InputEvent event) { if
			 * (Build.VERSION.SDK_INT >= 21) { if (mCustomWebViewClient != null)
			 * { mCustomWebViewClient.onUnhandledInputEvent(view, event); } else
		...
		super.setWebChromeClient(new WebChromeClient() {
			...
			// (public method)
			/*
			 * @SuppressWarnings("all") public boolean onShowFileChooser(WebView
			 * webView, ValueCallback<Uri[]> filePathCallback,
			 * WebChromeClient.FileChooserParams fileChooserParams) {
			 * openFileInput(null, filePathCallback); return true; }
			 * 
			 * @Override public void onProgressChanged(WebView view, int
			 * newProgress) { if (mCustomWebChromeClient != null) {
			 ...
			 * 
			 * @SuppressWarnings("all") public void
			 * onPermissionRequest(PermissionRequest request) { if
			 * (Build.VERSION.SDK_INT >= 21) { if (mCustomWebChromeClient !=
			 * null) { mCustomWebChromeClient.onPermissionRequest(request); }
			 * else { super.onPermissionRequest(request); } } }
			 * 
			 * @SuppressLint("NewApi")
			 * 
			 * @SuppressWarnings("all") public void
			 * onPermissionRequestCanceled(PermissionRequest request) { if
			 * (Build.VERSION.SDK_INT >= 21) { if (mCustomWebChromeClient !=
			 * null) {
		...
		setDownloadListener(new DownloadListener() {
			...
			public void onDownloadStart(String url, String userAgent,
					...
					long contentLength) {
				if (mListener != null) {
					mListener.onDownloadRequested(url, userAgent,
